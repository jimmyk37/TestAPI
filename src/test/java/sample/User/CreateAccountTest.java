...
public class CreateAccountTest  {
	...
	public void testCreateAccountSuccess() {
		...
		Response response = 
		        given().
		            ...
		            formParam("email", "jimmy@example.com").
		            formParam("password", "jimmy12345").
		            formParam("title", "Mr").
		            ...
		            formParam("company", "Example Corp").
	...
	public void testInvalidEmailFormat() {
		Response responsen = RestAssured.given()
				.params("name", "John Doe", "email", "johndoe", "password", "password123", "title", "Mr",
